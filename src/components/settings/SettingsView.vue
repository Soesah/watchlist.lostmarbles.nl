<template>
  <section class="settings">
    ...
    <p>
      See
      <router-link to="/settings/incomplete">incomplete items</router-link>(movies with N/A for runttime, series without seasons, etc.). See a pie chart for item types, and a bar chart for watched items.
    </p>
